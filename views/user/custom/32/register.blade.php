...
<!-- Wrapper -->
<div id="wrapper" class="wrapper official-page landing-page32 slider-menu slider-active">
  <div class="bgImage">
  ...
  <main class="main">
    <div class="container">
      <div class="official-body-text">
        <div class="win-big">
          <img src="{{ config('api.static_file_uri') }}/images/sofia_solo/header_text1a.png" alt="WIN BIG!" />
        </div>
        <div class="register-hoy">
          <img src="{{ config('api.static_file_uri') }}/images/sofia_solo/header_text2.png" alt="Registrese hoy y reciba un bona de 2000 creditors y hasta 10 hiros gratis!" />
        </div>
      </div>
    </div>
  </main>
