...
/***/ "./node_modules/@gamebetr/api-client-js/src/Services/affiliate.js":
/*!************************************************************************!*\
  !*** ./node_modules/@gamebetr/api-client-js/src/Services/affiliate.js ***!
  \************************************************************************/
...
/* harmony export */   "default": () => (/* binding */ Affiliate)
/* harmony export */ });
...
/* harmony import */ var _token__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../token */ "./node_modules/@gamebetr/api-client-js/src/token.js");
...
class Affiliate {
  ...
  getCookieAffiliateId() {
    let token = new _token__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
(() => {
/*!********************************!*\
  !*** ./assets/src/register.js ***!
  \********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_gamebetr_api_client_js_src_Services_affiliate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/@gamebetr/api-client-js/src/Services/affiliate */ "./node_modules/@gamebetr/api-client-js/src/Services/affiliate.js");
/* harmony import */ var _node_modules_gamebetr_api_client_js_src_Services_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/@gamebetr/api-client-js/src/Services/auth */ "./node_modules/@gamebetr/api-client-js/src/Services/auth.js");
/* harmony import */ var _node_modules_gamebetr_api_client_js_src_Services_event__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../node_modules/@gamebetr/api-client-js/src/Services/event */ "./node_modules/@gamebetr/api-client-js/src/Services/event.js");
/* harmony import */ var _node_modules_gamebetr_api_client_js_src_token__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../node_modules/@gamebetr/api-client-js/src/token */ "./node_modules/@gamebetr/api-client-js/src/token.js");
...
window.onload = function () {
  var token = new _node_modules_gamebetr_api_client_js_src_token__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  var flag = false; // for pixels

  var auth = new _node_modules_gamebetr_api_client_js_src_Services_auth__WEBPACK_IMPORTED_MODULE_1__["default"]();
  var event = new _node_modules_gamebetr_api_client_js_src_Services_event__WEBPACK_IMPORTED_MODULE_2__["default"](); // pixel events
  ...
  form.addEventListener('submit', function (e) {
    ...
    auth.validateRegister(username.value, email.value, password.value); // set affiliate if cookie exists

    var affiliate = new _node_modules_gamebetr_api_client_js_src_Services_affiliate__WEBPACK_IMPORTED_MODULE_0__["default"]();
    var affiliate_id = affiliate.getCookieAffiliateId();
    auth.register(username.value, email.value, password.value, affiliate_id).then(function (data) {
      if (data.data) {
        console.log(data);
        submit.textContent = 'Registering...'; // fire event

        event.registerEnd(data); // do conversion ids here

        var url_string = window.location.href;
        var url = new URL(url_string);
        affiliate.createConversion(token.getDomainId(), data.data.attributes.integer_id, affiliate_id, url.searchParams.get('t'), url.searchParams.get('c'), promo_code.value); // login and get token

        auth.login(email.value, password.value).then(function (data) {
          if (data.data) {
            console.log(data);
            submit.textContent = 'Logging In...'; // fire event
