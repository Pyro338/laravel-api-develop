  ...
  <div id="wrapper" class="wrapper landing-page8 landing-page10 slider-menu slider-active">
    ...
    <div class="register-box">
      ...
      <div id="logo" class="navbar-brand">
        <a href="/landing/page10" class="logo"><img src="{{ asset('gamebetr/images/logo.png') }}" alt="Playbetr"></a>
      </div><!-- #logo end -->
    ...
    <div class="main-chars-bg mt-auto"><img src="{{ asset('gamebetr/images/main_chars10.png') }}" alt="main chars" /></div>
  </div><!-- #wrapper end -->
