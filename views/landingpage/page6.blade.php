...
@section('title', 'Landing Page6')
@section('content')

  <!-- Wrapper -->
  <div id="wrapper" class="wrapper landing-page5 landing-page6 slider-menu slider-active">
    <!-- register box -->
    <div class="register-box">
      <a href="#" class="register-toggler">Close</a>
      <!-- Logo -->
      <div id="logo" class="navbar-brand">
        <a href="/landing/page6" class="logo"><img src="{{ asset('gamebetr/images/betcoin-ag.png') }}" alt="Betcoin"></a>
      </div><!-- #logo end -->
      <h4 class="title mb-0">Create your free account and claim your bonus!</h4>
    ...
    <main class="main h-100">
      <div class="container h-100 d-flex flex-column">
        ...
        <div class="text-center font-italic">
          ...
          <h1 class="text-xl">BITCOIN SPORTSBOOK & CASINO</h1>
        </div>
      </div>
    </main>
    <div class="main-chars-bg mt-auto"><img src="{{ asset('gamebetr/images/main_chars4.png') }}" alt="main chars" /></div>
  </div><!-- #wrapper end -->
