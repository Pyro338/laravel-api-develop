...
<!-- Wrapper -->
<div id="wrapper" class="wrapper official-page landing-page29 slider-menu slider-active">
  <div class="bgImage">
    ...
    <div class="container">
      <div class="official-body-text">
        <div class="official-logo-section">
          ...
          <div class="instalogo"><img src="{{ config('api.static_file_uri') }}/images/maria_psg/header_2_maria.png" alt="Instagram" /></div>
        </div>

        <div class="bonus-text">
          <div class="bonus-txt1"><img src="{{ config('api.static_file_uri') }}/images/maria_psg/header_text_1_maria.png" alt="WIN BIG!" /></div>
          <div class="bonus-txt2"><img src="{{ config('api.static_file_uri') }}/images/maria_psg/header_text_2.png" alt="Register" /></div>
        </div>
      </div>
    </div>
  </main>
