...
@section('title', 'Landing Page14')
@section('content')

  <!-- Wrapper -->
  <div id="wrapper" class="wrapper landing-page8 video-page landing-page14 slider-menu slider-active">
    <video autoplay muted loop id="bgVideo" preload="auto" poster="{{ asset('gamebetr/images/videopage/etherscan_bg_withgraphic_static.jpg') }}">
	  <source src="{{ asset('gamebetr/video/etherscan_bg_withgraphic_animated.mp4') }}" type="video/mp4">
	</video>
      ...
      <div class="container h-100 d-flex flex-column">
	    <div class="video-hightlight-content">
          <div class="maintext-section">
            <img src="{{ asset('gamebetr/images/videopage/etherscan_maintext.png') }}" alt="Playbetr">
          </div>
