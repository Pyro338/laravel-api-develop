...
@section('title', 'Landing Page7')
@section('content')

  <!-- Wrapper -->
  <div id="wrapper" class="wrapper landing-page5 landing-page7 slider-menu slider-active">
    <!-- register box -->
    <div class="register-box">
      <a href="#" class="register-toggler">Close</a>
      <!-- Logo -->
      <div id="logo" class="navbar-brand">
        <a href="/landing/page7" class="logo"><img src="{{ asset('gamebetr/images/betcoin-ag.png') }}" alt="Betcoin"></a>
      </div><!-- #logo end -->
    ...
    <div class="main-chars-bg mt-auto"><img src="{{ asset('gamebetr/images/main_chars5.png') }}" alt="main chars" /></div>
  </div><!-- #wrapper end -->
