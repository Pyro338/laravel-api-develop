...
<style>
  ...
  <!-- Wrapper -->
  <div id="wrapper" class="wrapper landing-page5 landing-page23 slider-menu slider-active">
    ...
    <main class="main pt-5">
	  <div class="interbox">
        <div class="utb-section"><img src="{{ config('api.static_file_uri') }}/images/utb_section2.png" alt="utb_section" /></div>
        <ul>
	      <li class="bitcion">
	        <h4>BscScan Signup Bonus</h4>
	        Get up to 500 BNP + 10 free spons!
	      </li>
	      <li class="choices">
