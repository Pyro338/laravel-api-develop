...
@section('title', 'Landing Page5')
@section('content')

  <!-- Wrapper -->
  <div id="wrapper" class="wrapper landing-page5 slider-menu slider-active">
    <!-- register box -->
    <div class="register-box">
      <a href="#" class="register-toggler">Close</a>
      <!-- Logo -->
      <div id="logo" class="navbar-brand">
        <a href="/landing/page5" class="logo"><img src="{{ asset('gamebetr/images/betcoin-ag.png') }}" alt="Betcoin"></a>
      </div><!-- #logo end -->
    ...
    <div class="main-chars-bg mt-auto"><img src="{{ asset('gamebetr/images/main_chars3.png') }}" alt="main chars" /></div>
  </div><!-- #wrapper end -->
