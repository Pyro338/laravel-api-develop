...
@section('content')
<style>
  #preloader .preloader-content .square {background:#232323;}
</style>
  <!-- Wrapper -->
  <div id="wrapper" class="wrapper official-page landing-page17 slider-menu slider-active">
      ...
      <div class="container">
	    <div class="official-body-text">
	      <div class="official-logo-section">
            <img src="{{ config('api.static_file_uri') }}/images/officialpage/top_heading_combined_A_regional_betting.png" alt="official regional betting partner" />
          </div>
