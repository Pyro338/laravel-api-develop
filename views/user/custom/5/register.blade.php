...
@section('content')
<style>
  #preloader .preloader-content .square {background:#6a1616;}
</style>
  ...
  <div id="wrapper" class="wrapper landing-page5 slider-menu slider-active">
    ...
    <div class="main-chars-bg mt-auto"><img src="{{ config('api.static_file_uri') }}/images/main_chars3.png" alt="main chars" /></div>
  </div><!-- #wrapper end -->
