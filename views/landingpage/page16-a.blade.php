...
@section('title', 'Landing Page16-a')
@section('content')
      ...
      <div class="container">
	    <div class="official-body-text">
	      <div class="official-logo-section">
            <img src="{{ asset('gamebetr/images/officialpage/top_heading_combined_A_regional_betting.png') }}" alt="official regional betting partner" />
          </div>
