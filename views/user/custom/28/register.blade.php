...
<!-- Wrapper -->
<div id="wrapper" class="wrapper official-page landing-page28 slider-menu slider-active">
  <div class="bgImage">
  ...
  <main class="main">
    <div class="container">
      <div class="official-body-text">
        <div class="win-big">
          <img src="{{ config('api.static_file_uri') }}/images/maria_solo/header_text1.png" alt="WIN BIG!" />
        </div>
