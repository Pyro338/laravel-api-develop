...
@section('content')
<style>
  #preloader .preloader-content .square {background:#133882;}
</style>
  ...
  <div id="wrapper" class="wrapper h-100 landing-page4 slider-menu slider-active">
    ...
    <main class="main h-100">
      <div class="container h-100 d-flex flex-column">
        ...
        <div class="main-chars-bg mt-auto"><img src="{{ config('api.static_file_uri') }}/images/main_chars2.png" alt="main chars" /></div>
      </div>
    </main>
  </div><!-- #wrapper end -->
