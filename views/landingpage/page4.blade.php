...
@section('title', 'Landing Page4')
@section('content')

  <!-- Wrapper -->
  <div id="wrapper" class="wrapper h-100 landing-page4 slider-menu slider-active">
    <!-- register box -->
    <div class="register-box">
      <a href="#" class="register-toggler">Close</a>
      <!-- Logo -->
      <div id="logo" class="navbar-brand">
        <a href="/landing/page4" class="logo"><img src="{{ asset('gamebetr/images/logo.png') }}" alt="Playbetr"></a>
      </div><!-- #logo end -->
    ...
    <main class="main h-100">
      <div class="container h-100 d-flex flex-column">
        ...
        <div class="main-chars-bg mt-auto"><img src="{{ asset('gamebetr/images/main_chars2.png') }}" alt="main chars" /></div>
      </div>
    </main>
  </div><!-- #wrapper end -->
