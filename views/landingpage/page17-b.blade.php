...
@section('title', 'Landing Page17-b')
@section('content')
      ...
      <div class="container">
	    <div class="official-body-text">
	      <div class="official-logo-section">
            <img src="{{ asset('gamebetr/images/officialpage/top_heading_combined_A_regional_partner.png') }}" alt="official regional betting partner" />
          </div>
