    ...
    <main class="main h-100">
      <div class="container h-100 d-flex flex-column">
        ...
        <div class="text-center font-italic">
          ...
          <h1 class="text-xl headingimg"><img src="{{ config('api.static_file_uri') }}/images/heading9.png" alt="ESPORTS SPORTSBOOK & CASINO" /></h1>
        </div>
      </div>
    </main>
    <div class="main-chars-bg mt-auto"><img src="{{ config('api.static_file_uri') }}/images/main_chars9.png" alt="main chars" /></div>
  </div><!-- #wrapper end -->
