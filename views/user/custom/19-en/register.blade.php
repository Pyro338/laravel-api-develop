      ...
      <div class="container">
	    <div class="official-body-text">
	      <div class="official-logo-section">
            <div class="blogo"><img src="{{ config('api.static_file_uri') }}/images/psg/logos_eng.png" alt="Betting partner of paris saint-germain" /></div>
            <div class="tagline"><img src="{{ config('api.static_file_uri') }}/images/psg/tagline_eng.png" alt="play with winning team today" /></div>
          </div>

          <div class="bonus-text">
            <img src="{{ config('api.static_file_uri') }}/images/psg/bonus_text_eng.png" alt="Sign up today and receive a 2,000 credit deposit bonus and up to 10 free spins!" /></div>
        </div>
      </div>
    </main>
  </div><!-- #wrapper end -->
